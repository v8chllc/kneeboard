...
1. Render the result comment in the shape `.claude/skills/feature-orchestrate/references/result-comment.md` defines, rolling criteria up from claims as it specifies.

...
The Claude Code port of `.agents/skills/feature-orchestrate/`. The references are identical to the Codex copy; `SKILL.md` and the five role agents under `.claude/agents/` are adapted to Claude Code's Agent, SendMessage, and Skill tools.
...
| `../../agents/feature-*-agent.md` | The plan, build, scope, proof, and publish roles, as Claude Code subagents |
